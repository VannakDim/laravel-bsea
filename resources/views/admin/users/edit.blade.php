                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <form method="POST" action="{{ url('/admin/user/'.Session::get('id')) }}" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('current_username') is-invalid @enderror " name="current_username" value="{{ old('current_username') }}" placeholder="Enter Username">
